...
RUN curl -o vsts-agent-linux-x64-${AGENT_VERSION}.tar.gz -L https://vstsagentpackage.azureedge.net/agent/${AGENT_VERSION}/vsts-agent-linux-x64-${AGENT_VERSION}.tar.gz \
